...
For anomaly-based ridge regressions for AllRG model
...
def main(model,best_alpha,rg_names,tgt_crs,K=1000,drop_K=25):
    print(model, tgt_crs)    
...
if __name__=="__main__":
    ...
    model= 'LR10c' #
    best_alpha= [1.58e03,6.31e03,6.31e03,1.58e03]
    ...
    if True:
        rg_nm= 'AllRG{}'.format(len(rg_names))
        output1,output2= main(model,best_alpha,rg_names,tgt_crs,K,drop_K)
