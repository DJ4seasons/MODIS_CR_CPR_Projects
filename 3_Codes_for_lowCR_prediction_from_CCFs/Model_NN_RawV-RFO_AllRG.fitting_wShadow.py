...
---
Including shadow variables to estimate SHAP/ALE criterion to decide meaningless variables
2026.07.27
...
if __name__=="__main__":
    ...
    out_fn_h= out_dir+'NN_rawVar18_scaled_12d_wShadow.'
