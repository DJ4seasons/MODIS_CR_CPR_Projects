...
def main(rg_names,tgt_crs,model_name):
    ...
    ## Prepare NNet model
    in_fn_h= indir1b+f'NN_rawVar{nv}_scaled_12d.'
    ...
    outfn= out_dir+model_name+'.shap_dict_{}.joblib'.format(shape_txt)
    ...
    outfn= out_dir+model_name+'.ale_result_dict_{}x{}x{}.joblib'.format(nv,ale_bins,ncr2)
